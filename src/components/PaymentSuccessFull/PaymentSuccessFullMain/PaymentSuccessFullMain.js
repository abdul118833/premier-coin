        ...
        <div>
            ...
            <div className='w-full flex justify-center sm:my-8 md:my-0'>
                <div className='sm:w-full md:w-1/3 sm:p-4 md:p-16 box_shadow rounded-xl sm:mx-4 flex flex-col items-center bg-white sm:mt-0 md:-mt-16 sm:mb-0 md:mb-16'>
                    <img src='success.png' className='w-96' />
                    <p className='my-6 text-center'>Your PTX balance will be updated shortly!</p>
                    <div className="mb-6">
                        <button className='bg-blue text-white rounded px-4 py-3 font-bold'>Back to my Account</button>
                    </div>
                </div>
            </div>
        </div>
